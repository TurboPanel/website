/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareEnv ./cloudflare-env.d.ts` (hash: c34cb5c941ea763dd09d60212f5aa24b)
// Runtime types generated with workerd@1.20260609.1 2026-02-14 global_fetch_strictly_public,nodejs_compat
...
declare namespace Cloudflare {
	interface TestingEnv {
		IMAGES: ImagesBinding;
		ASSETS: Fetcher;
		API_HOSTNAMES: "testing.turbopanel.dev,Testing API";
		WORKER_SELF_REFERENCE: Fetcher /* testing-website */;
	}
	interface StagingEnv {
		IMAGES: ImagesBinding;
		ASSETS: Fetcher;
		API_HOSTNAMES: "staging.turbopanel.dev,Staging API";
		WORKER_SELF_REFERENCE: Fetcher /* staging-website */;
	}
	interface LiveEnv {
		IMAGES: ImagesBinding;
		ASSETS: Fetcher;
		API_HOSTNAMES: "turbopanel.app,Production API";
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "API_HOSTNAMES">> {}
}
