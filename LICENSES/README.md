...
Storing a file under `public/` does not relicense it. Files that originate
from third parties remain subject to their original copyright, license, and
trademark terms, which must be recorded in this repository's third-party
notices. Unused framework-template assets should be removed rather than left
with ambiguous provenance.

Prior tagged releases of this repository remain available under the license
