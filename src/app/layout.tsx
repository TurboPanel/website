...
export const metadata: Metadata = {
  title: 'TurboPanel — Host more. Manage less.',
  description:
    'Run websites, apps, databases, and servers from one fast, always-on control plane. We run the panel — you connect servers and ship.',
  icons: {
