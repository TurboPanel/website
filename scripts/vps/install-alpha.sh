...
install -m 0640 "${here}/hook-lib.mjs" "${HOME}/bin/hook-lib.mjs"
install -m 0750 "${here}/ci-gate.mjs" "${HOME}/bin/ci-gate.mjs"
install -m 0640 "${here}/ci-gate-lib.mjs" "${HOME}/bin/ci-gate-lib.mjs"
