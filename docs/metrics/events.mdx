...
The kernel invoked the OOM killer. A process was sacrificed so the rest of the system could continue. Pair with [memory PSI](/docs/metrics/memory#memory-pressure) and [memory used](/docs/metrics/memory#memory-breakdown) in the same window.
