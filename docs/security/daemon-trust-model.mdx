...
Approved command types include deploy/stop, ping, hostname/reboot, timezone/NTP, TurboFabric reconcile, managed engine lifecycle, and orchestration playbooks invoked through Ansible.
