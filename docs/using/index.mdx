...
- **Admin → Access** publishes this control plane's hostnames and certificate sources on a self-hosted instance; on High Availability that is the operator's infrastructure.
...
| [Servers](/docs/using/servers) | Adding a server, the fleet, the control panel, organization server settings. |
| [Datacenters and networking](/docs/using/network) | Datacenters, addresses, Docker networks and pools, reserved ranges, the mesh. |
| [Notifications](/docs/using/notifications) | The bell, the event catalogue, channels and rules, delivery and retries. |
