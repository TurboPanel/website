...
| `conflict` | 409 | A storage or forge write collided with a concurrent one; retry. |
...
See [Accounts and access](/docs/getting-started/accounts-and-access).
...
| `stripe_error` | 502 | The billing provider returned an error. |
