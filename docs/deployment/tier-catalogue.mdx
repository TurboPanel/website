...
| You need | Where |
| --- | --- |
| A superadmin session | See [live admin bootstrap](/docs/deployment/control-plane) — on a wiped hosted database there is no signup and no admin until one is bootstrapped |
