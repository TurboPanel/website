...
| Issue | Solution |
| ----- | -------- |
| Connection failures | Verify `--host` / `TURBOPANEL_INSTANCE_URL`, firewall (a `ufw` default-deny on the control-plane host blocks 8443 until you `ufw allow 8443/tcp`), TLS CA trust |
