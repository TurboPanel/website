...
[`AGENTS.md` — Installer presentation layer](https://github.com/turbopanel/turbopanel-daemon/blob/trunk/AGENTS.md#installer-presentation-layer).
...
| Deno `deno run` fallback (only when the native binary cannot run) | `/opt/turbopanel/bin/turbopaneld.js` |
