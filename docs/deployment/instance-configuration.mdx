...
| `CADDY_PORT` | `8443` | **Development only.** The port the development Caddy unit (and the docs site's dev unit) listens on and links to. The instance does not read it: install origins always use `:8443`, and a managed Caddyfile binds `:8443` whatever this is set to. |
