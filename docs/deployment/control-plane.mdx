...
<Steps>
  ...
  <Step>
    ...
    Add `TURBOPANEL_UPDATE_CHANNEL=rc` to install the current release candidate instead of the latest release. The installer takes no license (the wizard issues the first one) and enrols no daemon.
  </Step>
  <Step>
