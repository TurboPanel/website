...
<Callout type="info" title="Co-located dev hosts">
  ...
  Those two actions exist only on that console; a managed self-hosted control plane
  upgrades by re-running the installer (see [Upgrade and rollback](/docs/deployment/upgrade)).
</Callout>
