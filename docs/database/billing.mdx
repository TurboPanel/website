...
Tables on this page: [`allowance`](#allowance) · [`entitlement`](#entitlement) · [`license`](#license) · [`payer`](#payer) · [`seat`](#seat) · [`subscription`](#subscription) · [`tier`](#tier). Generated from migration `0006_instance_hostnames`; see [How to read this](/docs/database#how-to-read-this-dictionary).
