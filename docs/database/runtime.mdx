...
Tables on this page: [`capability`](#capability) · [`command`](#command) · [`deployment`](#deployment) · [`dispatch`](#dispatch) · [`generation`](#generation) · [`key`](#key) · [`label`](#label) · [`monitor`](#monitor) · [`server`](#server) · [`slot`](#slot) · [`task`](#task). Generated from migration `0006_instance_hostnames`; see [How to read this](/docs/database#how-to-read-this-dictionary).
