...
Tables on this page: [`backup`](#backup) · [`managed`](#managed) · [`recovery`](#recovery) · [`replica`](#replica). Generated from migration `0007_add_upgrade_tables`; see [How to read this](/docs/database#how-to-read-this-dictionary).
