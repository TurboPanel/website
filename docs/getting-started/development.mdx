...
- Runs `scripts/bootstrap-orchestration.ts` (uv, Python, Ansible under `/opt/turbopanel/runtimes/`) and `install-daemon-systemd.sh`
...
└── runtimes/
    ├── deno/2.8.3/        # pinned Deno runtime (console-managed)
