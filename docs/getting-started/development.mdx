...
- **Remote test machines / extra daemons:** give your development host a hostname (for example `https://dev.lan:8443` or your LAN IP) so clients are not stuck on `localhost`. Ports `8443` / `8880` / `8081` / `8088` / `19820` listen on all host interfaces.
