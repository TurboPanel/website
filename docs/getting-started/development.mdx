...
description: Vagrant-based contributor setup — 16 GB RAM, sibling repos, ports, and day-to-day TurboPanel development
---
...
| Requirement | Minimum |
| --- | --- |
| **RAM** | **16 GB** — needed to run the Vagrant guest and host tooling together |
