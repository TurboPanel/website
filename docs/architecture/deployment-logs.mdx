...
<Callout type="info" title="Canonical source">
  Control-plane contract: <File path="src/features/execution-logs/AGENTS.md" href="https://github.com/TurboPanel/turbopanel/blob/trunk/src/features/execution-logs/AGENTS.md">turbopanel/src/features/execution-logs/AGENTS.md</File>.
  Daemon-side capture: <File path="src/deploy/AGENTS.md" href="https://github.com/TurboPanel/turbopaneld/blob/trunk/src/deploy/AGENTS.md">daemon/src/deploy/AGENTS.md</File> (Streamed transcript capture).
