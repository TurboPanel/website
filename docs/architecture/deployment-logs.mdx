...
<Callout type="info" title="Canonical source">
  Control-plane contract: <File path="src/lib/execution-logs/AGENTS.md" href="https://github.com/TurboPanel/turbopanel/blob/trunk/src/lib/execution-logs/AGENTS.md">instance/src/lib/execution-logs/AGENTS.md</File>.
