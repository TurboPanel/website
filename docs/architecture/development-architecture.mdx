...
| -------- | ----------- | ---- |
| `~/dev/` (or `./turbopanel-dev/`) | turbopanel/turbopanel-dev | `./console`, bootstrap installer, Ink dev UI |
| `~/daemon/` | turbopanel/turbopanel-daemon | Remote daemon + Ansible (installed by console) |
| `~/instance/` | turbopanel/instance | Hono API (Workers wrangler + Deno self-hosted) |
