...
| ---- | ------- | ------- |
| Deno | Console + instance runtime (installed by `./console`) | [deno.com](https://docs.deno.com/runtime/getting_started/installation/) — or let `./console` install the pinned version under `/opt/turbopanel/runtimes/deno/<version>/deno` (no `v` prefix) |
